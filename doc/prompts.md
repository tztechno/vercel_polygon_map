...
```
2024-08-01 12:30
polygonの中心にregion番号を記入する変更で
build中にmap.tsxでエラーが発生

./components/Map.tsx:24:13
Type error: Cannot find name 'setGeoJSONData'. Did you mean 'geoJSONData'?

  22 |     useEffect(() => {
  23 |         if (geoJSONData) {
> 24 |             setGeoJSONData(prevData => ({
     |             ^
  25 |                 ...prevData,
  26 |                 features: prevData.features.map(feature => ({
  27 |                     ...feature,
